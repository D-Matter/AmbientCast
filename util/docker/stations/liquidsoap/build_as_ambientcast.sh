...
/var/ambientcast/.opam/4.13.1/bin/liquidsoap /bd_build/stations/liquidsoap/build_chroot.liq || true

# Clear entire OPAM directory
rm -rf /var/ambientcast/.opam

cp -r /tmp/liquidsoap/var/ambientcast/.opam /var/ambientcast/.opam
