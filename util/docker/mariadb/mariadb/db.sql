...
--
-- Host: mariadb    Database: ambientcast
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ambientcast`;
USE `ambientcast`;

ALTER DATABASE `ambientcast` CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
