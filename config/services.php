...
return [
    ...
    App\Console\Application::class => static function (
        DI\Container $di,
        Ambient\SlimCallableEventDispatcher\CallableEventDispatcherInterface $dispatcher,
        App\Version $version,
        Environment $environment
    ) {
    ...
    // Event Dispatcher
    Ambient\SlimCallableEventDispatcher\CallableEventDispatcherInterface::class => static function (
        Slim\App $app,
        App\Plugins $plugins
    ) {
        $dispatcher = new Ambient\SlimCallableEventDispatcher\SlimCallableEventDispatcher($app->getCallableResolver());
    ...
    Psr\EventDispatcher\EventDispatcherInterface::class => DI\get(
        Ambient\SlimCallableEventDispatcher\CallableEventDispatcherInterface::class
    ),
    ...
    Symfony\Component\Serializer\Serializer::class => static function (
        ...
        $normalizers = [
            ...
            new Ambient\Normalizer\DoctrineEntityNormalizer($em, $classMetaFactory),
    ...
    Symfony\Component\Mailer\Transport\TransportInterface::class => static function (
        ...
        Ambient\SlimCallableEventDispatcher\CallableEventDispatcherInterface $eventDispatcher,
        Monolog\Logger $logger
    ) {
