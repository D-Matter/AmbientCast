...
abstract class CestAbstract
{
    ...
    protected string $login_username = 'ambientcast@ambientcast.com';
    protected string $login_password = 'AmbientCastFunctionalTests!';
    ...
    protected function setupCompleteUser(\FunctionalTester $I): void
    {
        ...
        $user->setName('AmbientCast Test User');
    ...
    protected function uploadTestSong(): Entity\StationMedia
    {
        ...
        $songSrc = '/var/ambientcast/www/resources/error.mp3';
