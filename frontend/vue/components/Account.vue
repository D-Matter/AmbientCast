        ...
        <b-row>
                        ...
                        <b-card-body body-class="card-padding-sm">
                            <b-media right-align vertical-align="center">
                                ...
                                <h2 v-else class="card-title">
                                    <translate key="lang_no_username">AmbientCast User</translate>
                                </h2>
            ...
            <b-col sm="12" md="6" lg="7">
                <b-card no-body>
                    ...
                    <info-card>
                        <translate key="lang_api_keys_info">Use API keys to authenticate with the AmbientCast API using the same permissions as your user account.</translate>
