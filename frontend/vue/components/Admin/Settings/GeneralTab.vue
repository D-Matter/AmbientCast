    ...
    <b-form-fieldset>
        <b-form-row>
            ...
            <b-wrapped-form-group class="col-md-6" id="edit_form_instance_name" :field="form.instance_name">
                <template #label="{lang}">
                    <translate :key="lang">AmbientCast Instance Name</translate>
                </template>
                <template #description="{lang}">
                    <translate :key="lang">This name will appear as a sub-header next to the AmbientCast logo, to help identify this server.</translate>
                </template>
            </b-wrapped-form-group>
