<template>
    <div>
        <b-form-fieldset>
            <template #label>
                <translate key="lang_section_update_checks">AmbientCast Update Checks</translate>
            </template>
            ...
            <b-form-row>
                <b-form-markup class="col-md-6" id="form_release_channel">
                    ...
                    <template #description="{lang}">
                        <a href="https://ambient.kwafgroup.com/en/docs/getting-started/updates/release-channels"
                           target="_blank">
                            <translate :key="lang">Learn more about release channels in the AmbientCast docs.</translate>
                        </a>
                    </template>
                ...
                <b-wrapped-form-checkbox class="col-md-6" id="edit_form_check_for_updates"
                    ...
                    <template #description="{lang}">
                        <translate
                            :key="lang">Show new releases within your update channel on the AmbientCast homepage.</translate>
                    </template>
        ...
        <b-form-fieldset>
            ...
            <b-form-row>
                <b-wrapped-form-group class="col-md-6" id="edit_form_acme_domains"
                    ...
                    <template #description="{lang}">
                        <translate
                            :key="lang">All listed domain names should point to this AmbientCast installation. Separate multiple domain names with commas.</translate>
                    </template>
