                ...
                <b-form-row>
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <p class="card-text">
                                <translate key="lang_instructions_1a">Shoutcast 2 DNAS is not free software, and its restrictive license does not allow AmbientCast to distribute the Shoutcast binary.</translate>
                            </p>
