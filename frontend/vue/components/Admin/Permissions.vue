<template>
    <div>
        <b-card no-body>
            ...
            <info-card>
                <p class="card-text">
                    <translate key="lang_card_info">AmbientCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.</translate>
                </p>
            </info-card>
