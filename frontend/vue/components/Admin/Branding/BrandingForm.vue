                        ...
                        <b-form-row>
                            ...
                            <b-col md="6">
                                ...
                                <b-wrapped-form-checkbox id="form_edit_hide_product_name"
                                    ...
                                    <template #label="{lang}">
                                        <translate :key="lang">Hide AmbientCast Branding on Public Pages</translate>
                                    </template>
                                    <template #description="{lang}">
                                        <translate :key="lang">If selected, this will remove the AmbientCast branding from public-facing pages.</translate>
                                    </template>
                                </b-wrapped-form-checkbox>
                            </b-col>
                            ...
                            <b-wrapped-form-group class="col-md-6" id="form_edit_homepage_redirect_url"
                                ...
                                <template #description="{lang}">
                                    <translate :key="lang">If a visitor is not signed in and visits the AmbientCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.</translate>
                                </template>
                            </b-wrapped-form-group>
