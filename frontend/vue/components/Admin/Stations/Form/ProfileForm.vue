            ...
            <b-form-row>
                ...
                <b-wrapped-form-group class="col-md-6" id="edit_form_url" :field="form.url" input-type="url">
                    ...
                    <template #description="{lang}">
                        <translate :key="lang">Note: This should be the public-facing homepage of the radio station, not the AmbientCast URL. It will be included in broadcast details.</translate>
                    </template>
                </b-wrapped-form-group>
