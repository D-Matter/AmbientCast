                    ...
                    <b-form-fieldset>
                        <b-form-row>
                            <b-wrapped-form-checkbox class="col-md-12" id="edit_form_backend_record_streams"
                                ...
                                <template #description="{lang}">
                                    <translate :key="lang">If enabled, AmbientCast will automatically record any live
            ...
            <b-form-fieldset v-if="showAdvanced">
                ...
                <b-form-row>
                    <b-wrapped-form-checkbox class="col-md-6"
                        ...
                        <template #description="{lang}">
                            <translate :key="lang">This mode disables AmbientCast's AutoDJ management, using Liquidsoap
