                ...
                <b-form-row>
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <p class="card-text">
                                <translate key="lang_instructions_1a">Stereo Tool is not free software, and its restrictive license does not allow AmbientCast to distribute the Stereo Tool binary.</translate>
                            </p>
