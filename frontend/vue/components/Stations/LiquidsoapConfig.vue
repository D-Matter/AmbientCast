    ...
    <form class="form vue-form" @submit.prevent="submit">
        <section class="card" role="region">
            ...
            <info-card>
                ...
                <p class="card-text">
                    <translate key="lang_ls_config_2">The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by AmbientCast.</translate>
                </p>
                <p class="card-text">
                    <translate key="lang_ls_config_3">This is an advanced feature and custom code is not officially supported by AmbientCast. You may break your station by adding custom code, but removing it should fix any issues.</translate>
                </p>
            </info-card>
