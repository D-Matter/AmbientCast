<template>
    <b-modal size="lg" id="queue_modal" ref="modal" :title="langTitle" :busy="loading">
        <p>
            <translate key="queue_info">This queue contains the remaining tracks in the order they will be queued by the AmbientCast AutoDJ (if the tracks are eligible to be played).</translate>
        </p>
