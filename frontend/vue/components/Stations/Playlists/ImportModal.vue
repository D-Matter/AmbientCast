        ...
        <b-form v-else class="form" @submit.prevent="doSubmit">
            <b-form-group label-for="import_modal_playlist_file">
                ...
                <template #description>
                    <translate key="lang_form_playlist_file_desc">AmbientCast will scan the uploaded file for matches in this station's music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.</translate>
                </template>
