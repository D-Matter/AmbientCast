<template>
    <div class="card">
        ...
        <div class="card-body">
            <p class="card-text">
                <translate key="lang_connection_wiki">Setup instructions for broadcasting software are available on the AmbientCast wiki.</translate>
                <br>
                <a href="https://ambient.kwafgroup.com/en/docs/user-guide/streaming-software" target="_blank">
                    <translate key="lang_connection_wiki_link">AmbientCast Wiki</translate>
                </a>
            </p>
        </div>
    </div>
