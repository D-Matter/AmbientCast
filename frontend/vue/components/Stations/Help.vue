        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <a href="https://ambient.kwafgroup.com/en/docs/user-guide/troubleshooting" target="_blank">
                ...
                <div class="card-actions">
                    <a class="btn btn-outline-primary" role="button"
                       href="https://github.com/D-Matter/AmbientCast/issues/new/choose" target="_blank">
