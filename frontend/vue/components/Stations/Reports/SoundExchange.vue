        ...
        <form id="report-form" class="form vue-form" method="GET" :action="apiUrl" target="_blank">
            <div class="card-body">
                <b-form-fieldset>
                    ...
                    <ul>
                        <li>AmbientCast assumes that your station fits SoundExchange Transmission Category A, "Eligible
                        ...
                        <li>The data collected by AmbientCast meets the SoundExchange standard for Actual Total
                        ...
                        <li>Reporting requirements for SoundExchange may change at any time. AmbientCast is non-commercial
                            community-built software and cannot guarantee that its reporting format will always be
                            up-to-date.
                        </li>
                        <li>You should always verify the report generated by AmbientCast before sending it. In particular,
                ...
                <b-form-fieldset>
                    ...
                    <b-wrapped-form-checkbox name="fetch_isrc" id="form_edit_fetch_isrc" :field="$v.form.fetch_isrc">
                        ...
                        <template #description="{lang}">
                            <translate :key="lang">If enabled, AmbientCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.</translate>
                        </template>
