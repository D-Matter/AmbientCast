            ...
            <b-form-row class="mb-3">
                ...
                <b-wrapped-form-group class="col-md-12" id="edit_form_custom_listen_url"
                    ...
                    <template #description="{lang}">
                        <translate :key="lang">You can set a custom URL for this stream that AmbientCast will use when referring to it. Leave empty to use the default value.</translate>
                    </template>
