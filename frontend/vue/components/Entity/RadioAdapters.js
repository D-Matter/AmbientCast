export const FRONTEND_ICECAST = 'icecast';
export const FRONTEND_SHOUTCAST = 'shoutcast2';
export const FRONTEND_REMOTE = 'remote';
...
export const REMOTE_AMMBIENTRELAY = 'ambientrelay';
