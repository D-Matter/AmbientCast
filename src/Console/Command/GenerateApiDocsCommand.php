...
#[AsCommand(
    name: 'ambientcast:api:docs',
    description: 'Trigger regeneration of AmbientCast API documentation.',
)]
final class GenerateApiDocsCommand extends CommandAbstract
{
    ...
    public function generate(
        ...
        string $apiBaseUrl = 'https://ambient.kwafgroup.com/demo/api'
    ): ?OpenApi {
        define('AMBIENTCAST_API_URL', $apiBaseUrl);
        define('AMBIENTCAST_API_NAME', 'AmbientCast Public Demo Server');
        define(
            'AMBIENTCAST_VERSION',
