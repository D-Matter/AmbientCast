...
#[AsCommand(
    name: 'ambientcast:config:migrate',
...
final class MigrateConfigCommand extends CommandAbstract
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ('ambientcast' === $envSettings[Environment::DB_HOST]) {
            $envSettings[Environment::DB_HOST] = 'localhost';
        }

        $envSettings[Environment::DB_PORT] ??= '3306';
        $envSettings[Environment::DB_NAME] ??= 'ambientcast';
        $envSettings[Environment::DB_USER] ??= 'ambientcast';

        $iniData = [
            ';',
            '; AmbientCast Environment Settings',
            ';',
            '; This file is automatically generated by AmbientCast.',
            ';',
            '[configuration]',
        ];
