...
#[AsCommand(
    name: 'ambientcast:restore',
    description: 'Restore a backup previously generated by AmbientCast.',
)]
final class RestoreCommand extends AbstractBackupCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->runCommand($output, 'ambientcast:setup', ['--update' => true]);
