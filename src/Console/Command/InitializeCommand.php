...
#[AsCommand(
    name: 'ambientcast:setup:initialize',
    description: 'Ensure key settings are initialized within AmbientCast.',
)]
final class InitializeCommand extends CommandAbstract
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title(__('Initialize AmbientCast'));
        ...
        $io->success(
            [
                __('AmbientCast is now initialized.'),
            ]
        );
