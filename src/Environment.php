...
final class Environment
{
    ...
    public const RELEASE_CHANNEL = 'AMBIENTCAST_VERSION';

    public const SFTP_PORT = 'AMBIENTCAST_SFTP_PORT';
    ...
    /**
     * @return string The parent directory the application is within, i.e. `/var/ambientcast`.
     */
    ...
    public function getDatabaseSettings(): array
    {
        $dbSettings = [
            ...
            'dbname' => $this->data[self::DB_NAME] ?? 'ambientcast',
            'user' => $this->data[self::DB_USER] ?? 'ambientcast',
            'password' => $this->data[self::DB_PASSWORD] ?? 'ambient4c457',
        ];
