...
final class AmbientCastEnvFile extends AbstractEnvFile
{
    /** @inheritDoc */
            ...
            $config = [
                ...
                Environment::PROFILING_EXTENSION_ENABLED => [
                    ...
                    'description' => sprintf(
                        ...
                        'http://your-ambientcast-site/?SPX_KEY=dev&SPX_UI_URI=/',
                    ),
                ],
    ...
    {
        return $baseDir . DIRECTORY_SEPARATOR . 'ambientcast.env';
    }
}
