...
#[
    OA\OpenApi(
        openapi: '3.0.0',
        info: new OA\Info(
            version: AMBIENTCAST_VERSION,
            description: "AmbientCast is a standalone, turnkey web radio management tool. Radio stations hosted by"
            . " AmbientCast expose a public API for viewing now playing data, making requests and more.",
            title: 'AmbientCast',
        ...
        servers: [
            new OA\Server(
                url: AMBIENTCAST_API_URL,
                description: AMBIENTCAST_API_NAME
            ),
        ],
        tags: [
            new OA\Tag(
        ...
        externalDocs: new OA\ExternalDocumentation(
            description: "AmbientCast on GitHub",
            url: "https://github.com/D-Matter/AmbientCast"
        )
    ),
    OA\Parameter(
