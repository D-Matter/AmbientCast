...
class Settings implements Stringable
{
    ...
    #[
        OA\Property(description: "Site Base URL", example: "https://your.ambientcast.site"),
    ...
    #[
        OA\Property(description: "AmbientCast Instance Name", example: "My AmbientCast Instance"),
        ORM\Column(length: 255, nullable: true),
        Groups(self::GROUP_GENERAL)
    ]
    ...
    #[
        OA\Property(description: "Hide AmbientCast Branding on Public Pages", example: "false"),
        ORM\Column,
        Groups(self::GROUP_BRANDING)
    ]
    ...
    #[
        OA\Property(description: "The name of the sender of system e-mails.", example: "AmbientCast"),
        ORM\Column(length: 255, nullable: true),
        Groups(self::GROUP_GENERAL)
    ]
