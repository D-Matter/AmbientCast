...
use Ambient\Normalizer\Attributes\DeepNormalize;
use DateTimeZone;
...
class Station implements Stringable, IdentifiableEntityInterface
{
    ...
    #[
        OA\Property(description: "The full display name of the station.", example: "AmbientTest Radio"),
    ...
    #[
        OA\Property(example: "https://ambient.kwafgroup.com/demo/"),
    ...
    #[
        OA\Property(example: "/var/ambient/stations/ambienttest_radio"),
        ORM\Column(length: 255, nullable: true),
        Serializer\Groups([EntityGroupsInterface::GROUP_ADMIN, EntityGroupsInterface::GROUP_ALL])
    ]
    ...
    /**
     * Whether the station uses AmbientCast to directly manage the AutoDJ or lets the backend handle it.
     */
