...
use Aws\S3\S3Client;
use Ambient\Files\Adapter\AwsS3\AwsS3Adapter;
use Ambient\Files\Adapter\Dropbox\DropboxAdapter;
use Ambient\Files\Adapter\ExtendedAdapterInterface;
use Ambient\Files\Adapter\Local\LocalFilesystemAdapter;
use Ambient\Files\Adapter\LocalAdapterInterface;
use Ambient\Files\Adapter\Sftp\SftpAdapter;
use Ambient\Files\ExtendedFilesystemInterface;
use Ambient\Files\LocalFilesystem;
use Ambient\Files\RemoteFilesystem;
...
class StorageLocation implements Stringable, IdentifiableEntityInterface
{
    ...
    public const DEFAULT_BACKUPS_PATH = '/var/ambient/backups';
